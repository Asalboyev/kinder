...
<div class="col-12 col-md-12 col-lg-12">
    <form action="{{ route('admin.approaches.store')}}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="card">
            <div class="card-header">
                <h4>Create Approaches </h4>
            </div>
            <div class="card-body">
                ...
                <div class="form-group">
                    <label>Icon</label>
                    <input type="text" class="form-control" name="icon" multiple>
                </div>
